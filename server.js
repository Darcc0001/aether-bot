...
function renderPage(options) {
  ...
  const brandMarkup = config.brandLogoUrl
    ? [
        ...
        `  <img class="brand-image" src="${escapeHtml(config.brandLogoUrl)}" alt="Aether logo" onerror="this.style.display='none'; this.previousElementSibling.style.display='grid';" onload="this.previousElementSibling.style.display='none';" />`,
        '</div>',
      ].join('\n')
  ...
  return [
    ...
    '      height: 108px;',
      ...
      '      display: grid;',
      '      place-items: center;',
      '      border: 1px solid rgba(213, 164, 73, 0.30);',
      '      background: linear-gradient(180deg, rgba(213, 164, 73, 0.18), rgba(213, 164, 73, 0.05));',
      '      color: var(--gold);',
      '      font-size: 34px;',
      '      font-weight: 700;',
      '      letter-spacing: 0.08em;',
    '      box-shadow: inset 0 1px 0 rgba(240, 207, 139, 0.08), 0 18px 40px rgba(0, 0, 0, 0.22);',
    '      position: relative;',
    '    }',
    '    .brand-letter {',
    ...
    '      inset: 7px;',
    '      border-radius: 23px;',
    '      border: 1px solid rgba(240, 207, 139, 0.10);',
    '      pointer-events: none;',
    '    }',
    '    .brand-image {',
    '      display: block;',
      ...
      '      filter: drop-shadow(0 0 16px rgba(213, 164, 73, 0.18)) saturate(1.04);',
    '    }',
    '    .badge {',
    '      display: inline-flex;',
    '      align-items: center;',
    ...
    '      .brand { width: 94px; height: 94px; border-radius: 26px; }',
    '      .brand-image { border-radius: 18px; transform: scale(1.08); }',
    '      .button { width: 100%; }',
    '    }',
    '  </style>',
    '</head>',
